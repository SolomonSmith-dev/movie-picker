...
class TestAPIEndpoints:
    ...
    def test_mark_movie_as_watched_endpoint(self):
        ...
        result = self._test_endpoint("/users/1/watch-history", method="POST", data=data, expected_status=404)
        if not result:
            result = self._test_endpoint("/users/1/watch-history", method="POST", data=data, expected_status=200)
