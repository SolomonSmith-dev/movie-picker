...
async def get_watch_history(
    ...
    try:
        ...
        for entry in history:
            movie = entry['movie']
            history_responses.append(WatchHistoryResponse(
                movie_id=movie['id'],
...
async def mark_as_watched(
    ...
    try:
        ...
        if success:
            ...
            raise HTTPException(status_code=500, detail="Failed to mark movie as watched")
            
    except HTTPException:
        raise
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Error marking movie as watched: {str(e)}")
