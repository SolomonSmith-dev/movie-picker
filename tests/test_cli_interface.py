...
from src.ui.cli_interface import CLIInterface, load_movies, fallback, pick_random_movie, pick_movie_by_genres, show_movie, pick_movie_of_the_day, log_movie_to_history
...
class TestCLIHelperFunctions:
    ...
    def test_load_movies(self):
        ...
        with patch("builtins.open", mock_open(read_data='[{"title": "Test Movie", "year": 2023}]')):
    ...
    def test_pick_random_movie(self):
        ...
        with patch("random.choice") as mock_choice:
            ...
            mock_choice.assert_called_once_with([{"title": "Movie 2"}, {"title": "Movie 3"}])
...
class TestCLIInterface:
    ...
    @patch("builtins.input")
    @patch("builtins.print")
    def test_get_user_choice_invalid_then_valid(self, mock_print, mock_input, cli_interface):
    ...
    @patch("builtins.input")
    @patch("builtins.print")
    def test_search_movies(self, mock_print, mock_input, mock_movie_manager, cli_interface, sample_movie):
    ...
    @patch("builtins.input")
    @patch("builtins.print")
    def test_browse_by_genre(self, mock_print, mock_input, mock_movie_manager, cli_interface, sample_movie):
    ...
    @patch("src.ui.cli_interface.movie_manager")
    @patch("builtins.print")
    def test_show_top_rated(self, mock_print, mock_movie_manager, cli_interface, sample_movie):
    ...
    @patch("src.ui.cli_interface.movie_manager")
    @patch("builtins.print")
    def test_show_recent_movies(self, mock_print, mock_movie_manager, cli_interface, sample_movie):
    ...
    @patch("builtins.input")
    @patch("builtins.print")
    def test_filter_by_year(self, mock_print, mock_input, mock_movie_manager, cli_interface, sample_movie):
    ...
    @patch("builtins.input")
    @patch("builtins.print")
    def test_filter_by_rating(self, mock_print, mock_input, mock_movie_manager, cli_interface, sample_movie):
        ...
        mock_movie_manager.advanced_filter.assert_called_once_with(
            rating_min=8.0, rating_max=10.0, order_by="rating", order_direction="desc", limit=20
        )
        print_calls = [str(call) for call in mock_print.call_args_list]
        printed_output = " ".join(print_calls)
    ...
    @patch("builtins.input")
    @patch("builtins.print")
    def test_filter_by_genre_input(self, mock_print, mock_input, mock_movie_manager, cli_interface, sample_movie):
        ...
        mock_movie_manager.advanced_filter.assert_called_once_with(genres=["Action"], limit=20)
        print_calls = [str(call) for call in mock_print.call_args_list]
        printed_output = " ".join(print_calls)
        assert "Movies in Action genre" in printed_output
    ...
    @patch("builtins.input")
    @patch("builtins.print")
    def test_filter_by_director(self, mock_print, mock_input, mock_movie_manager, cli_interface, sample_movie):
        ...
        mock_movie_manager.advanced_filter.assert_called_once_with(directors=["Christopher Nolan"], limit=20)
        print_calls = [str(call) for call in mock_print.call_args_list]
        printed_output = " ".join(print_calls)
    ...
    @patch("builtins.input")
    @patch("builtins.print")
    def test_show_movie_of_the_day(self, mock_print, mock_input, mock_datetime, mock_movie_manager, cli_interface, sample_movie):
    ...
    @patch("builtins.input")
    @patch("builtins.print")
    def test_show_movie_of_the_day_mark_watched(self, mock_print, mock_input, mock_datetime, mock_movie_manager, cli_interface, sample_movie):
    ...
    @patch("src.ui.cli_interface.movie_manager")
    @patch("builtins.print")
    def test_show_watch_history_empty(self, mock_print, mock_movie_manager, cli_interface):
    ...
    def test_show_statistics(self, mock_print, mock_movie_manager, cli_interface):
        ...
        mock_history = [
            {
                'movie': {'title': 'Movie 1', 'year': 2023, 'genres': 'Action, Thriller'},
